...
#ifndef COREROLLERSHUTTERSTATUSREQUEST_H
#define COREROLLERSHUTTERSTATUSREQUEST_H

#include "control/CoreRmRequest.h"
#include "rollershutter/RollerShutterStatusRequest.h"

namespace deltadoreX2d
{

class CoreRollerShutterStatusRequest : public CoreRmRequest , public virtual RollerShutterStatusRequest
{
    public :
        CoreRollerShutterStatusRequest();
        ~CoreRollerShutterStatusRequest();
...
#endif // COREROLLERSHUTTERSTATUSREQUEST_H
