...
#ifndef CORESETROOMTEMPERATUREREQUEST_H
#define CORESETROOMTEMPERATUREREQUEST_H

#include "control/CoreRmRequest.h"
#include "sensor/SetRoomTemperatureRequest.h"

namespace deltadoreX2d
{

class CoreSetRoomTemperatureRequest : public CoreRmRequest , public virtual SetRoomTemperatureRequest
{
    public :
        CoreSetRoomTemperatureRequest();
        ~CoreSetRoomTemperatureRequest();
...
#endif // CORESETROOMTEMPERATUREREQUEST_H
