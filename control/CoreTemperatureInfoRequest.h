...
#ifndef CORETEMPERATUREINFOREQUEST_H
#define CORETEMPERATUREINFOREQUEST_H

#include "control/CoreRmRequest.h"
#include "sensor/TemperatureInfoRequest.h"

namespace deltadoreX2d
{

class CoreTemperatureInfoRequest : public CoreRmRequest , public virtual TemperatureInfoRequest
{
    public :
        CoreTemperatureInfoRequest();
        ~CoreTemperatureInfoRequest();
...
#endif // CORETEMPERATUREINFOREQUEST_H
