...
#ifndef CORETHERMICINFOREQUEST_H
#define CORETHERMICINFOREQUEST_H

#include "control/CoreRmRequest.h"
#include "hvac/ThermicInfoRequest.h"

namespace deltadoreX2d
{

class CoreThermicInfoRequest : public CoreRmRequest , public virtual ThermicInfoRequest
{
    public :
        CoreThermicInfoRequest();
        ~CoreThermicInfoRequest();
...
#endif // CORETHERMICINFOREQUEST_H
