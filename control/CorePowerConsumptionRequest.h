...
#ifndef COREPOWERCONSUMPTIONREQUEST_H
#define COREPOWERCONSUMPTIONREQUEST_H

#include "control/CoreRmRequest.h"
#include "metering/PowerConsumptionRequest.h"

namespace deltadoreX2d
{

class CorePowerConsumptionRequest : public CoreRmRequest, public virtual PowerConsumptionRequest
{
    public :
        CorePowerConsumptionRequest();
        ~CorePowerConsumptionRequest();
...
#endif // COREPOWERCONSUMPTIONREQUEST_H
