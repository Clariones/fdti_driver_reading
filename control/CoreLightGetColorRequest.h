...
#ifndef CORELIGHTGETCOLORREQUEST_H
#define CORELIGHTGETCOLORREQUEST_H

#include "control/CoreRmRequest.h"
#include "light/LightGetColorRequest.h"

namespace deltadoreX2d
{

class CoreLightGetColorRequest : public CoreRmRequest, public virtual LightGetColorRequest
{
    public :
        CoreLightGetColorRequest();
        ~CoreLightGetColorRequest();
...
#endif // CORELIGHTGETCOLORREQUEST_H
