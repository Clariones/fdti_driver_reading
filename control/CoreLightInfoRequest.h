...
#ifndef CORELIGHTINFOREQUEST_H
#define CORELIGHTINFOREQUEST_H

#include "control/CoreRmRequest.h"
#include "light/LightInfoRequest.h"

namespace deltadoreX2d
{

class CoreLightInfoRequest : public CoreRmRequest, public virtual LightInfoRequest
{
    public :
        CoreLightInfoRequest();
        ~CoreLightInfoRequest();
