...
#ifndef CORETHERMICREGULATIONCOMMANDREQUEST_H
#define CORETHERMICREGULATIONCOMMANDREQUEST_H

#include "control/CoreRmRequest.h"
#include "hvac/ThermicRegulationCommandRequest.h"

namespace deltadoreX2d
{

class CoreThermicRegulationCommandRequest : public CoreRmRequest, public virtual ThermicRegulationCommandRequest
{
	public :
        CoreThermicRegulationCommandRequest();
        ~CoreThermicRegulationCommandRequest();
...
#endif // CORETHERMICREGULATIONCOMMANDREQUEST_H
