...
#ifndef COREROLLERSHUTTERSETTINGREQUEST_H
#define COREROLLERSHUTTERSETTINGREQUEST_H

#include "control/CoreRmRequest.h"
#include "rollershutter/RollerShutterSettingRequest.h"

namespace deltadoreX2d
{

 class CoreRollerShutterSettingRequest : public CoreRmRequest, public virtual RollerShutterSettingRequest
 {
    public :
        CoreRollerShutterSettingRequest();
        ~CoreRollerShutterSettingRequest();
...
#endif // COREROLLERSHUTTERSETTINGREQUEST_H
