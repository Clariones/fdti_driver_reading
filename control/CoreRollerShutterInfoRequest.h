...
#ifndef COREROLLERSHUTTERINFOREQUEST_H
#define COREROLLERSHUTTERINFOREQUEST_H

#include "control/CoreRmRequest.h"
#include "rollershutter/RollerShutterInfoRequest.h"

namespace deltadoreX2d
{

class CoreRollerShutterInfoRequest : public CoreRmRequest , public virtual RollerShutterInfoRequest
{
    public :
        CoreRollerShutterInfoRequest();
        ~CoreRollerShutterInfoRequest();
...
#endif // COREROLLERSHUTTERINFOREQUEST_H
