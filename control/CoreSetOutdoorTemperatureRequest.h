...
#ifndef CORESETOUTDOORTEMPERATUREREQUEST_H
#define CORESETOUTDOORTEMPERATUREREQUEST_H

#include "control/CoreRmRequest.h"
#include "sensor/SetOutdoorTemperatureRequest.h"

namespace deltadoreX2d
{

class CoreSetOutdoorTemperatureRequest : public CoreRmRequest , public virtual SetOutdoorTemperatureRequest
{
    public :
        CoreSetOutdoorTemperatureRequest();
        ~CoreSetOutdoorTemperatureRequest();
...
#endif // CORESETOUTDOORTEMPERATUREREQUEST_H
