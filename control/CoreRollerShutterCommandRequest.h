...
#ifndef COREROLLERSHUTTERCOMMANDREQUEST_H
#define COREROLLERSHUTTERCOMMANDREQUEST_H

#include "control/CoreRmRequest.h"
#include "rollershutter/RollerShutterCommandRequest.h"

namespace deltadoreX2d
{

class CoreRollerShutterCommandRequest : public CoreRmRequest, public virtual RollerShutterCommandRequest
{
    public :
        CoreRollerShutterCommandRequest();
        ~CoreRollerShutterCommandRequest();
...
#endif // COREROLLERSHUTTERCOMMANDREQUEST_H
