...
#ifndef CORELIGHTSETTINGREQUEST_H
#define CORELIGHTSETTINGREQUEST_H

#include "control/CoreRmRequest.h"
#include "light/LightSettingRequest.h"

namespace deltadoreX2d
{

class CoreLightSettingRequest : public CoreRmRequest, public virtual LightSettingRequest
{
    public :
        CoreLightSettingRequest();
        ~CoreLightSettingRequest();
...
#endif // CORELIGHTSETTINGREQUEST_H
