...
#ifndef CORELIGHTSTATUSREQUEST_H
#define CORELIGHTSTATUSREQUEST_H

#include "control/CoreRmRequest.h"
#include "light/LightStatusRequest.h"

namespace deltadoreX2d
{

class CoreLightStatusRequest : public CoreRmRequest, public virtual LightStatusRequest
{
    public :
        CoreLightStatusRequest();
        ~CoreLightStatusRequest();
...
#endif // CORELIGHTSTATUSREQUEST_H
