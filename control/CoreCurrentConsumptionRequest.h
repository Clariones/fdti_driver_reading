...
#ifndef CORECURRENTCONSUMPTIONREQUEST_H
#define CORECURRENTCONSUMPTIONREQUEST_H

#include "control/CoreRmRequest.h"
#include "metering/CurrentConsumptionRequest.h"

namespace deltadoreX2d
{

class CoreCurrentConsumptionRequest : public CoreRmRequest, public virtual CurrentConsumptionRequest
{
    public :
        CoreCurrentConsumptionRequest();
        ~CoreCurrentConsumptionRequest();
...
#endif // CORECURRENTCONSUMPTIONREQUEST_H
