...
#ifndef COREENERGYCONSUMPTIONREQUEST_H
#define COREENERGYCONSUMPTIONREQUEST_H

#include "control/CoreRmRequest.h"
#include "metering/EnergyConsumptionRequest.h"

namespace deltadoreX2d
{

class CoreEnergyConsumptionRequest : public CoreRmRequest, public virtual EnergyConsumptionRequest
{
    public :
        CoreEnergyConsumptionRequest();
        ~CoreEnergyConsumptionRequest();
...
#endif // COREENERGYCONSUMPTIONREQUEST_H
