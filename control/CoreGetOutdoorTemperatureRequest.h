...
#ifndef COREGETOUTDOORTEMPERATUREREQUEST_H
#define COREGETOUTDOORTEMPERATUREREQUEST_H

#include "control/CoreRmRequest.h"
#include "sensor/GetOutdoorTemperatureRequest.h"

namespace deltadoreX2d
{

class CoreGetOutdoorTemperatureRequest : public CoreRmRequest , public virtual GetOutdoorTemperatureRequest
{
    public :
        CoreGetOutdoorTemperatureRequest();
        ~CoreGetOutdoorTemperatureRequest();
...
#endif // COREGETOUTDOORTEMPERATUREREQUEST_H
